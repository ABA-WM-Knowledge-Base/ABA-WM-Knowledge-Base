...
**Related pages:** [Reasoner](reasoner.md) covers text output; [Action modeling](action-modeling.md) covers action schemas; [Policy](policy.md) covers DROID control; [Reproduction](reproduction.md) records actual load and run outcomes.
