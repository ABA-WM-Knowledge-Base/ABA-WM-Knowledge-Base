...
The six entries are non-exclusive. For example, action-conditioned video planning may require representation, dynamics, reasoning, generative-modeling, action-conditioning, and world-model–policy-interface knowledge together with canonical action, planning, and evaluation pages from Foundations.
