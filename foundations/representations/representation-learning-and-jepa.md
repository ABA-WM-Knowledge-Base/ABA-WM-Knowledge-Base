...
- [Predictive embeddings](../../components/world-representation/predictive-embeddings.md) owns reconstruction-free embeddings as world state; planning use remains on [predictive representation and latent planning](../../components/reasoning/predictive-representation-and-planning.md).
