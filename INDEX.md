...
| Fast Video Inference | Learned sampling-step reduction, training-free intermediate caching, and sparse/local/linear attention; speed–quality trade-offs and implementation boundaries | [Knowledge map](components/fast-video-inference/README.md) |
