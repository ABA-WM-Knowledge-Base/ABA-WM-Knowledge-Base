...
**Related pages:** [autoregressive modeling](../../foundations/learning-objectives/autoregressive-modeling.md); [forward dynamics](../../foundations/problem-formulation/forward-dynamics.md); [model-based RL](../../foundations/decision-making/model-based-rl.md); [Generative Modeling Component](../../components/generative-modeling/README.md); [Cosmos3-Nano action modeling](../../models/cosmos3-nano/action-modeling.md); [Cosmos3-Nano generator](../../models/cosmos3-nano/generator.md).
